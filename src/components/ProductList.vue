        ...
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            <div v-if="showSkeleton" class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                ...
                <div v-for="n in 8" :key="n" class="group relative animate-pulse">
                    <div
                        class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 dark:bg-gray-600 lg:aspect-none lg:h-80">
            ...
            <div v-else class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                <div v-for="product in products" :key="product.id" class="group relative">
                    <div
                        class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 dark:bg-gray-600 lg:aspect-none group-hover:opacity-75 lg:h-80">
...
const addToCart = (product) => {
    // Your logic to add the product to cart
